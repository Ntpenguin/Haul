...
const BASE_PRICES = { 'Just a few items': 17500, 'Studio': 35000, '1 BR': 50000, '2 BR': 80000, '3 BR': 135000, '4+ BR / full house': 160000 };
const STAIRS_SURCHARGE = 3000, LONG_CARRY = 5000, TAX = 0.0825;
...
const scenarios = [
  ...
  { name: '1 BR, stairs both ends (2+1 flights)', size: '1 BR', stairs_p: 'Stairs', flights_p: 2, stairs_d: 'Both', flights_d: 1 },
